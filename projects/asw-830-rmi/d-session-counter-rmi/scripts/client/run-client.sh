...
# Script per l'avvio del client RMI per Session Counter. 
...
echo Starting session counter client [servizio su ${SERVERHOST}]
...
# base dir BD=/home/vagrant/projects/asw-830-rmi/d-session-counter-rmi/dist/client
