...
# Script per l'avvio del client RMI per Hello. 
...
echo Starting hello client [servizio su ${SERVERHOST}]
...
# base directory: BD=/home/vagrant/projects/asw-830-rmi/a-hello-rmi/dist/client
