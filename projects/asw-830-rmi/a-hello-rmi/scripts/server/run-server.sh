...
# Script per l'avvio del server RMI per Hello. 
...
echo Starting hello server su ${SERVERHOST}
...
# base dir BD=/home/vagrant/projects/asw-830-rmi/a-hello-rmi/dist/server
